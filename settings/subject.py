...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btnUpdateSubject = QtWidgets.QPushButton(self.centralwidget)
        self.btnUpdateSubject.setGeometry(QtCore.QRect(150, 280, 75, 31))
        self.btnUpdateSubject.setObjectName("btnUpdateSubject")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(280, 230, 101, 31))
        self.label_2.setObjectName("label_2")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(30, 230, 101, 31))
        self.label.setObjectName("label")
        self.btnDeleteSubject = QtWidgets.QPushButton(self.centralwidget)
        self.btnDeleteSubject.setGeometry(QtCore.QRect(270, 280, 75, 31))
        self.btnDeleteSubject.setObjectName("btnDeleteSubject")
        self.editSubjectID = QtWidgets.QLineEdit(self.centralwidget)
        self.editSubjectID.setGeometry(QtCore.QRect(110, 230, 131, 31))
        self.editSubjectID.setObjectName("editSubjectID")
        self.editSubjectName = QtWidgets.QLineEdit(self.centralwidget)
        self.editSubjectName.setGeometry(QtCore.QRect(360, 230, 131, 31))
        self.editSubjectName.setObjectName("editSubjectName")
        self.btnAddSubject = QtWidgets.QPushButton(self.centralwidget)
        self.btnAddSubject.setGeometry(QtCore.QRect(30, 280, 75, 31))
        self.btnAddSubject.setObjectName("btnAddSubject")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(20, 20, 471, 192))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.btnQuitSubject = QtWidgets.QPushButton(self.centralwidget)
        self.btnQuitSubject.setGeometry(QtCore.QRect(380, 280, 75, 31))
        self.btnQuitSubject.setObjectName("btnQuitSubject")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 515, 33))
        ...
        # 为添加按钮关联槽函数
        self.btnAddSubject.clicked.connect(self.add)
        # 表格项被单击时调用getItem
        self.tableWidget.itemClicked.connect(self.getItem)
        # 为修改按钮关联槽函数
        self.btnUpdateSubject.clicked.connect(self.edit)
        # 为删除按钮关联槽函数
        self.btnDeleteSubject.clicked.connect(self.delete)
        # 为退出按钮关联槽函数
    ...
    # 自定义槽函数,向年级表中添加数据
    def add(self):
        subid = self.editSubjectID.text()  # 获取年级的编号
        subname = self.editSubjectName.text()  # 获取年级的名称
        if subid != '' and subname != '':
            if self.getName(subname) > 0:
                ...
                # 执行添加操作
                result = service.exec('insert into tb_subject values(%s,%s)', (subid, subname))
                if result > 0:
    ...
    def getItem(self, item):
        if item.column() == 0:  # 第一列
            ...
            self.editSubjectID.setText(self.select)
        ...
        try:
            if self.select != '':
                ...
                if subname != '':
                    ...
                    if self.getName(subname) > 0:
                        # 存在
                        QMessageBox.information(None, '提示', '要修改的考试科目已经存在', QMessageBox.Ok)
                        pass
                    else:
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnAddSubject.setText(_translate("MainWindow", "添加"))
